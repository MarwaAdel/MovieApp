...
import com.example.myapplication.details.MovieDetailActivity;
import com.example.myapplication.details.MovieDetailFragment;
...
public class MovieListActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>,
    ...
    private MovieListActivity.RetainedFragment mRetainedFragment;
...
//        setSupportActionBar(mToolbar);
        ...
        String tag = MovieListActivity.RetainedFragment.class.getName();
        this.mRetainedFragment = (RetainedFragment) getSupportFragmentManager().findFragmentByTag(tag);
        if (this.mRetainedFragment == null) {
            this.mRetainedFragment = new MovieListActivity.RetainedFragment();
